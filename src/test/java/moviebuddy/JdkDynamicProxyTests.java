 ...
 * - 대상 객체에 부가 기능을 부여하기 위해서는 매번 부가 기능 객체를 만들고 대상 객체에 의존 관계 주입을 해줘야 한다.
 * - 자바에는 JDK에서 제공하는 동적 프락시 외에도 프락시를 다룰 수 있도록 지원해주는 다양한 기술들이 존재하는데,
 *   이렇게 특정 기술을 이용해 동적 프락시를 생성하 추후 기술의 한계나 다른 필요에 의해 프락시 기술에 대한 변경이 어려워진다.
 *
